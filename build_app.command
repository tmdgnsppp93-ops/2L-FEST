#!/bin/bash
# =============================================================
# GEDO  -  standalone app builder (PyInstaller)
# macOS   -> dist/GEDO.app        (더블클릭 실행, 파이썬 불필요)
# Windows -> dist/GEDO/GEDO.exe     (이 스크립트를 Windows에서 실행)
#
...
echo "  macOS:   open 'dist/GEDO.app'"
echo "  Windows: dist/GEDO/GEDO.exe"
