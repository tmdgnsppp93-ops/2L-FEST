...
"""Step (3a): drive GEDOS single-cell solver headlessly, dump IV + geometry.

Goal: get (V, J) curve + metrics from the REAL GEDOS FEM solver for the
default single cell, and discover the exact geometry attributes we need to
build a matching Solcore mask in step (3b).

    <solcore venv>/bin/python drive_gedos.py
"""
